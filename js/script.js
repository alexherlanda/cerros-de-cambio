(function($) {
	...
	if ($('.single-item-carousel').length) {
        ...
        //Agent-style-two
		if ($('.events-style-one .bxslider').length) {
		$('.events-style-one .bxslider').bxSlider({
	        nextSelector: '.events-style-one #slider-next',
	        prevSelector: '.events-style-one #slider-prev',
	        nextText: '<i class="fa fa-angle-right"></i>',
	        prevText: '<i class="fa fa-angle-left"></i>',
	        mode: 'fade',
	        auto: 'true',
	        speed: '700',
	        pagerCustom: '.events-style-one .slider-pager .thumb-box'
	    });
	};
	...
	//Project Carousel
	if ($('.project-item-carousel').length) {
		$('.project-item-carousel').owlCarousel({
			loop:true,
			margin:2,
			nav:true,
			smartSpeed: 700,
